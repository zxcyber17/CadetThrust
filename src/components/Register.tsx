...
export const Register: React.FC<RegisterProps> = ({ onSwitchToLogin, onRegisterSuccess }) => {
  ...
  // নতুন স্টেট: রেজিস্ট্রেশন সফল হয়েছে কি না তা ট্র্যাক করার জন্য
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // রেজিস্ট্রেশন সফল হওয়ার পর নিয়ন ক্যাডেট সফল স্ক্রিনটি দেখাবে
      setIsRegistered(true)

      // ৩.৫ সেকেন্ড পর লগইন পেজে রিডাইরেক্ট হবে
      setTimeout(() => {
        onSwitchToLogin()
      }, 3500)
    } catch (err) {
  ...
  // যদি রেজিস্ট্রেশন সফল হয়, তবে ফর্মের বদলে আপনার নতুন `succes_page.jpg` ওয়ালা SuccessScreen রেন্ডার হবে
  if (isRegistered) {
