    ...
    <div className="register-container slide-in-right">
      <div className="card-neon">
        <div className="logo-container">
          <div className="logo-circle glow-magenta">
        ...
        <h1 className="neon-glow">REGISTRATION</h1>
      ...
      <style>{`
        ...
        .logo-circle {
          ...
          height: 140px;
          margin: 0 auto;
          background: radial-gradient(circle at 30% 30%, rgba(255, 0, 110, 0.2), rgba(0, 212, 255, 0.1));
          border: 3px solid var(--neon-magenta);
          border-radius: 50%;
          display: flex;
          align-items: center;
          justify-content: center;
          box-shadow: 0 0 20px var(--neon-magenta), 0 0 40px rgba(255, 0, 110, 0.3), inset 0 0 20px rgba(255, 0, 110, 0.1);
        ...
        @keyframes pulse-magenta {
          ...
          50% {
            box-shadow: 0 0 30px var(--neon-magenta), 0 0 60px rgba(255, 0, 110, 0.5), inset 0 0 30px rgba(255, 0, 110, 0.2);
          }
        }
